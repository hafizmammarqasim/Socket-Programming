...
public class User {
    ...
    {
        messages[0] = new Message(0,"Ammar", "Hi, Ali", 1, "Hi Ammar", "Ali");
        messages[1] = new Message(1, "Ali", "Hi, Ammar",0, "Hi, Ali", "Ammar" );
    }
    ...
    public void receiveMessage(Message sentmsg){
        ...
        {
            for(int i=0; i<messages.length; i++){
                if(messages[i].getMessage().equals(sentmsg.getReply())){
    ...
    public Message replyMessage(){
        ...
        if(counter>0) {
            ...
            for (int i = 0; i < messages.length; i++) {
                if (replyId.equalsIgnoreCase(messages[i].getMessageId())) {
                    flagForMessage = i;
                    break;
                }
            }
        ...
        }else if(messages[flagForMessage] == null || messages[flagForMessage].getReply() == null && messages[flagForMessage].getMessage() == null) {
